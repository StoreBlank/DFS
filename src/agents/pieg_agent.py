...
class Encoder(nn.Module):
    def __init__(self, obs_shape):
        ...
        self.apply(utils_pieg.weight_init)
...
class Actor(nn.Module):
    ...
    def forward(self, obs, std):
        ...
        dist = utils_pieg.TruncatedNormal(mu, std)
        return dist
...
class PIEGAgent:
    ...
    def act(self, obs, step, eval_mode):
        ...
        stddev = utils_pieg.schedule(self.stddev_schedule, step)
    ...
    def update(self, replay_iter, step):
        ...
        obs, action, reward, discount, next_obs = utils_pieg.to_torch(
            batch, self.device)
        ...
        # strong augmentation
        aug_obs = self.encoder(utils_pieg.random_overlay(original_obs))
        ...
        utils_pieg.soft_update_params(self.critic, self.critic_target,
